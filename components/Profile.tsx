...
const Profile: React.FC = () => {
  return (
    <div className="flex flex-col justify-center items-center text-center lg:mt-[60px]">
      ...
      <motion.h2 initial={{ scale: 0 }} whileInView={{ scale: 1, transition: { delay: 2, type: "spring", stiffness: 100 } }} className='hidden lg:block text-white text-xs font-normal mb-[17.45px] lg:mb-[38px]'>XBorg001</motion.h2>
      <motion.img
        initial={{ opacity: 0, y: 200 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ delay: 1, duration: 1.2 }}
