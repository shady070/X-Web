...
const Hero = () => {
  return (
    ...
    <motion.div initial={{ y:100, opacity:0 }} whileInView={{ y:0, opacity:1, transition: { delay: 1.5, duration:0.8}  }} whileHover={{ initial: { scale:1 },  }} className='flex flex-col justify-center items-center mt-[60px]'>
